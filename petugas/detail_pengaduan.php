...
<div class="card shadow">
  ...
  <div class="form group cols-sm-6">
    ...
    <span class="text">Tanggapi & Verifikasi</span>
  </a>
</div>
    ...
    <form action="" method="post" class="form-horizontal" enctype="multipart/form-data">
      ...
      <div class="form-group cols-sm-6">
        ...
        <input type="text" name="tgl_pengaduan" value="<?php echo $data['tgl_pengaduan']; ?>" class="form-control" readonly></div>
