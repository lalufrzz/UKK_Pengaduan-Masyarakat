    ...
    <form action="simpan_pengaduan.php" method="post" class="form-horizontal" enctype="multipart/form-data">
      <div class="form-group cols-sm-6">
       ...
       <div class="form-group cols-sm-6">
        ...
        <input type="file" name="foto" class="form-control" accept=".jpg, .jpeg, .png, .gif"><font color="red"> tipe format foto yang bisa diupload yaitu : JPG,JPEG,PNG & GIF </font>
      </div>
