      ...
      <li class="nav-item">
        ...
        <div id="collapseThree" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="cetak_masyarakat.php" target="_blank">Laporan Masyarakat</a>
            <a class="collapse-item" href="cetak_laporan.php" target="_blank">Laporan Pengaduan</a>
            <a class="collapse-item" href="cetak_tanggapan.php" target="_blank">Laporan Tanggapan</a>
          </div>
        </div>
      </li>
